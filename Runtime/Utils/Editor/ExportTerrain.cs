...
namespace Ouroboros.Common.Utils
{
    ...
    class ExportTerrain : EditorWindow
    {
        ...
        [MenuItem("Ouroboros/Utils/Export Terrain To Obj")]
        static void Init()
        {
            terrain = null;
        ...
        void OnGUI()
        {
            ...
            saveResolution = (SaveResolution)
                EditorGUILayout.EnumPopup("Resolution", saveResolution);
        ...
        void Export()
        {
            ...
            for (int y = 0; y < h; y++)
            {
                ...
                {
                    tVertices[y * w + x] =
                        Vector3.Scale(meshScale, new Vector3(-y, tData[x * tRes, y * tRes], x))
                        + terrainPos;
